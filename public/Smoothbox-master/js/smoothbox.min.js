$(document).ready(function() {
    $(".sb").on('click', function(e) {
        ...
        $(".sb").reverse().each(function() {
            ...
            } else { $(".sb-items").append('<div class="sb-item"><img src="' + e + '"/></div>') }
        });
    ...
    $(document).on('click', ".sb-cancel", function(e) {
        $(".smoothbox").fadeOut("slow", function() { $(".smoothbox").remove() });
        e.preventDefault()
    });
    $(document).on('click', ".sb-next-on", function(e) {
        $(this).removeClass("sb-next-on");
        $(".sb-item:last").addClass("sb-item-ani");
        $(".sb-item:last").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function() {
