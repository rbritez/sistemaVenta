...
var cargarSelectMultple = '<div class="form-group" id="eliminarselect" >' +
    ...
    '<div class="col-sm-8">' +
    '<select multiple class="form-control" name="permiso[]" id="permiso_id" disabled>' +
    '</select>' +
    '</div>' +
    '</div>';
        ...
        $.ajax({
            ...
            success: function(datos) {
                if (datos == 0) {
                    ...
                    alertify.alert("RESULTADO SATISFACTORIO", "SE ACTUALIZARON LOS DATOS CON EXITO", function() {
                        location.reload();
                    });
                }
            }
